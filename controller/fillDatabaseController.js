    ...
    try{
        ...
        for(var i=0; i < carparkArray.length; i++){
            ...
            const newCarpark = await pool.query
                ...
                [carpark._id, carpark.car_park_type, carpark.x_coord, carpark.y_coord, carpark.free_parking, carpark.gantry_height, carpark.car_park_basement, carpark.car_park_no, carpark.address, carpark.short_term_parking, carpark.type_of_parking_system, carpark.night_parking]
            );
